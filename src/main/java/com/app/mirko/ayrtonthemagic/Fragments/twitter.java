...
public class twitter extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.imageTwitter).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (viewId) {
            ...
            case R.id.imageTwitter:
                Uri uri = Uri.parse("https://twitter.com/ayrtonsenna"); // missing 'http://' will cause crashed
